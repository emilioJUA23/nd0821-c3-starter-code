...
def test_train_model():
    ...
    assert isinstance(model, RandomForestClassifier) and isinstance(accuracy, float)
...
def test_compute_model_metrics():
    ...
    # Define threshold values for passing the test (you can adjust these as needed)
